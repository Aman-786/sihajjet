//Splashscreen text
const String tAppName = "Hi , There";
const String tAppTagLine = "Learn To Live.\n Education Free For All";

//On boarding text
const String tOnBoardingTitle1 = "Welcome to Gurukul ";
const String tOnBoardingTitle2 =
    "Explore a world knowledge with our diverse range of courses";
const String tOnBoardingTitle3 =
    "Immerse yourself in interactive learning experiences.";
const String tOnBoardingSubTitle1 =
    "A diverse group of students engaged in learning, with books and digital devices around them.";
const String tOnBoardingSubTitle2 =
    " A vibrant collage showcasing various subjects like science, math, literature, and technology.";
const String tOnBoardingSubTitle3 =
    "A split-screen displaying a student actively participating in a virtual lab experiment and another solving a problem on a digital device.";
const String tOnBoardingCounter1 = "1/3";
const String tOnBoardingCounter2 = "2/3";
const String tOnBoardingCounter3 = "3/3";

//Welcome screen text
const String tWelcomeTitle = "Build";
const String tWelcomeSubTitle = "Welcome bro";
...
const String tOtpMesage = "Enter the verification code sent at";
...
const String tJoinedAt = "19 december 2023";
